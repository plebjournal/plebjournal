            ...
            div [ _class "col-sm-12 col-md-6" ] [
                ...
                div [ _class "mb-3" ] [
                    ...
                    input [
                        ...
                        _name "Password"
                        _type "password"
                        if passwordErrors then _class "form-control is-invalid" else _class "form-control"
                    ]
                    if passwordErrors then
                        div [ _class "invalid-feedback" ] [ str errs.Value.Password.Value ]
                    else div [] []
